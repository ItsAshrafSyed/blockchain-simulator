...
class Tokens extends Component {
        ...
        this.state = {
            ...
            blocks: [
                ...
                },
                {
                    ...
                    chain: 1,
                    nonce: 21501,
                    previous: '000013c51fc7812e3ccbb832e357f603ee6c17f81a5752f5271435d36d953625',
    ...
    mine(index, block) {
        ...
        let res = "0000" + hash.slice(4); console.log(res)
    ...
    text = {
        ...
        green: " bg-lime-50 border text-[#52c41a] text-sm rounded border-[#52c41a] px-2 overflow-x-scroll scrollbar-thin text-[13px] max-md transition-all",
        txt: "text-sm",
        ...
        return (
            <>
                <div className="flex flex-col space-y-5 justify-center items-center" >
                    <span className="text-4xl m-[5px] font-pop w-auto mx-auto justify-center " aria-current="page">Tokens</span>
                            ...
                            return (
                                <><div className={this.styles.wrapper} key={index}>
                                    ...
                                    <div className="text-2xl font-pop">
                                        ...
                                        BLOCK #{item.block} <span className="text-xs">{this.state.users[0].chain[0].timestamp.split("(")[0]}</span>

                                        <button disabled={item.hash.slice(0, 4) === "0000"} onClick={() => { this.mine(index, item); }} className={`${item.hash.slice(0, 4) === "0000" ? "cursor-not-allowed bg-gradient-to-r from-gray-300 via-gray-400 to-gray-500 hover:bg-gradient-to-br focus:ring-4 focus:outline-none" : "bg-gradient-to-r from-gray-300 via-gray-400 to-gray-500 hover:bg-gradient-to-br focus:ring-4 focus:outline-none bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 shadow-lg shadow-purple-500/50 dark:shadow-lg dark:shadow-purple-800/80 flex items-center text-white font-medium rounded-lg  px-4 space-x-2 py-[5px]  transition-all text-white font-pop bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 "} float-right flex hover:bg-gradient-to-br focus:ring-4 focus:outline-none  hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 shadow-lg shadow-purple-500/50 dark:shadow-lg dark:shadow-purple-800/80 flex items-center text-white font-medium rounded-lg  px-4 space-x-2 py-[5px]  transition-all text-white font-pop`}><GiMiner /><span>Mine</span> </button>
                                                        ...
                                                        return (
                                                            <div className="flex m-[1px]">
                                                                ...
                                                                <div className="flex-1 rounded-r-lg p-[5px] text-sm font-light bg-red-50">
                                                                    <input value={data.wallet} onwheel="return false;" type="number" className="w-[50px] border-none  text-sm   bg-red-50"
                                    ...
                                    <div className="flex">
                                        <div className={this.styles.inputtext}>
                                            Tx :
                                        </div>
                                                    ...
                                                    item.trans.map((object, i) => {
                                                        ...
                                                        return (
                                                            <>
                                                                ...
                                                                <div className={`${object.status == true ? " " : "bg-red-50 filter text-red-400"} ${"flex"}`}>
                                                                    <div className="flex  rounded-l-lg p-[5px] text-sm font-light bg-gray-50">
                                                                        $
                                                                    </div>
                                                                    <div className="flex-1 rounded-r-lg p-[5px] text-sm font-light bg-red-50">
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            onChange={(e) => {
                                                                                ...
                                                                                let res = item.balance.filter((data) => { if (data.name === object.from) { return data } })
                                    ...
                                    <div className={this.text.wrapper}>
                                        <div className={this.text.prev}>
                                            ...
                                            <div className={`${item.previous.slice(0, 4) === "0000" ? this.text.greenprev : this.text.redprev} ${this.text.scroll}`}>{item.previous}</div>
                                        </div>
                                        <div className={this.text.prev}>
                                            <p className={this.text.txt}>HASH</p>
                                            <div className={`${item.hash.slice(0, 4) === "0000" ? this.text.green : this.text.red} ${this.text.scroll}`}>{item.hash}</div>
                                        </div>
                                    </div>
                                </div>
                                    {
                                        (index != this.state.blocks.length - 1) && <FcExpand className="h-10 w-10" />
                                    }
                                </>
