...
const Chain = ({chain,setChain,setChain1,setChain2}) => {
  //Back Process
  var difficulty = 4;
  ...
  function addBlock(data) {
    ...
    setChain1(ch=>[...ch, {... block, previous: ch[chain.length - 1].hash}]);
    setChain2(ch => [...ch,{... block, previous: ch[chain.length - 1].hash,}]);
