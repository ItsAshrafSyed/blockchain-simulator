...
export default function Add({ handle }) {
  const styles = {
    ...
    button:
      "bg-gray-800  focus:ring-2 focus:outline-none focus:ring-gray-500 text-white font-bold w-full flex items-center  justify-center space-x-2 max-w-[12rem] py-2 px-4 rounded",
  }
